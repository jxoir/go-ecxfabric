...
// WithUUID adds the uuid to the delete by Id using d e l e t e params
func (o *DeleteByIDUsingDELETEParams) WithUUID(uuid string) *DeleteByIDUsingDELETEParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the delete by Id using d e l e t e params
func (o *DeleteByIDUsingDELETEParams) SetUUID(uuid string) {
	o.UUID = uuid
}
